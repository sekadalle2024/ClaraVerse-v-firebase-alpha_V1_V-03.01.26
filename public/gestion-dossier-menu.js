...
(function () {
    ...
    class GestionDossierMenu {
        ...
        createFloatingButton() {
            // Vérifier si le bouton flottant existe déjà
            if (document.getElementById('gestion-electro-floating-btn')) return;

            const floatingBtn = document.createElement('button');
            floatingBtn.id = 'gestion-electro-floating-btn';
            floatingBtn.innerHTML = '📂';
            floatingBtn.title = 'Gestion électronique des documents';
            ...
            floatingBtn.addEventListener('mouseenter', () => {
                ...
                floatingBtn.style.boxShadow = '0 6px 20px rgba(66, 133, 244, 0.5)';
            });
            floatingBtn.addEventListener('mouseleave', () => {
                floatingBtn.style.transform = 'scale(1)';
                floatingBtn.style.boxShadow = '0 4px 15px rgba(66, 133, 244, 0.4)';
            });
            floatingBtn.addEventListener('click', () => this.toggle());

            document.body.appendChild(floatingBtn);
            debug.log('✅ Bouton flottant Gestion électro créé');
        }
