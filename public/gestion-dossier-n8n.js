...
(function () {
    ...
    class GestionDossierN8N {
        ...
        createFloatingButton() {
            if (document.getElementById('gestion-electro-floating-btn-n8n')) return;
            const floatingBtn = document.createElement('button');
            floatingBtn.id = 'gestion-electro-floating-btn-n8n';
            floatingBtn.className = 'gdn-floating-btn';
            floatingBtn.innerHTML = '📂';
            floatingBtn.title = 'Gestion électronique des documents (N8N)';
            floatingBtn.addEventListener('click', () => this.toggle());
            document.body.appendChild(floatingBtn);
            debug.log('Bouton flottant N8N créé');
        }
