...
(function () {
    ...
    class GestionDossierMenuV2 {
        ...
        createFloatingButton() {
            if (document.getElementById('gestion-electro-floating-btn-v2')) return;

            const floatingBtn = document.createElement('button');
            floatingBtn.id = 'gestion-electro-floating-btn-v2';
            floatingBtn.innerHTML = '📂';
            floatingBtn.title = 'Gestion électronique des documents (V2)';
            ...
            floatingBtn.addEventListener('mouseenter', () => {
                ...
                floatingBtn.style.boxShadow = '0 6px 25px rgba(66, 133, 244, 0.6)';
            });
            floatingBtn.addEventListener('mouseleave', () => {
                floatingBtn.style.transform = 'scale(1) rotate(0deg)';
                floatingBtn.style.boxShadow = '0 4px 20px rgba(66, 133, 244, 0.5)';
            });
            floatingBtn.addEventListener('click', () => this.toggle());

            document.body.appendChild(floatingBtn);
            debug.log('Bouton flottant V2 créé');
        }
